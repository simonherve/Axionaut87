...
X = np.concatenate((X_hard_right, X_right, X_straight, X_left, X_hard_left)) # We concatenate the five datasets in one for the X.
y = np.concatenate((y_hard_right, y_right, y_straight, y_left, y_hard_left)) # We concatenate the five datasets in one for the y.
